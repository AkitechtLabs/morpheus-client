...
module.exports = new Command('login')
  ...
  .action(function(options) {
    ...
    return prompt(options, [{
      type: 'confirm',
      name: 'collectUsage',
      message: 'Allow Morpheus to collect anonymous CLI usage information?'
    }]).then(function() {
